<template>
  <NuxtLayout
    ...
    :breadcrumbs="[
      ...
      { title: 'IGA / Livelihoods', href: '/activities/iga', current: true },
    ]"
  >
    <div class="coming-soon-page">
      <div class="coming-soon-card">
        ...
        <h1 class="coming-soon-title">IGA / Livelihoods</h1>
        <p class="coming-soon-desc">IGA participant enrolment and grant tracking</p>

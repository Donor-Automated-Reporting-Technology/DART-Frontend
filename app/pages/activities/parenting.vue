<template>
  <NuxtLayout
    ...
    :breadcrumbs="[
      ...
      { title: 'Parenting', href: '/activities/parenting', current: true },
    ]"
  >
    <div class="parenting-page">
      <div class="page-header">
        <h1 class="page-title">Parenting Sessions</h1>
        <p class="page-subtitle">Track 14-session parenting programme for caregivers.</p>
      </div>
      ...
      <div v-else-if="!selectedGroup" class="empty-state">
        Select or create a parenting group to begin.
      </div>
      ...
      <template v-else>
        ...
        <div class="session-controls">
          ...
          <div class="field">
            ...
            <input v-model.number="currentSession" type="number" class="field-input field-narrow" min="1" :max="modules[currentModule]?.sessions || 3" />
          </div>
          <div class="field">
      ...
      <div v-if="showCreate" class="modal-overlay" @click.self="showCreate = false">
        <div class="modal-box">
          <div class="modal-header">
            <h3 class="modal-title">Create Parenting Group</h3>
            <button class="modal-close" @click="showCreate = false">&times;</button>
          </div>
          <div class="modal-body">
            <div class="field">
              <label class="field-label">Group Name</label>
              <input v-model="newGroup.name" type="text" class="field-input" placeholder="e.g. Parenting Group A" />
            </div>
            <div class="field">
...
import { useParenting, PARENTING_MODULES } from '../../composables/useParenting'
...
const modules = PARENTING_MODULES
...
async function handleCreate() {
  const activityId = authStore.frameworkActivities?.find(
    (a: any) => a.code === 'parenting' || a.template_code === 'parenting',
  )?.id || ''
...
<style scoped>
.parenting-page { max-width: 1000px; }

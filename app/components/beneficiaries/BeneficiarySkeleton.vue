  ...
  <div class="skeleton-table">
    ...
    <div class="skeleton-table-container">
      <div class="skeleton-header-row">
        <div class="skeleton-header-cell skeleton-pulse" v-for="i in 7" :key="'h'+i" />
      </div>
      <div
        v-for="row in rows"
        :key="row"
      ...
      >
        ...
        <div class="skeleton-cell skeleton-cell--name">
          ...
          <div class="skeleton-line skeleton-line--tertiary skeleton-pulse" />
        </div>
        <!-- Age -->
        ...
        <!-- Actions -->
        <div class="skeleton-cell skeleton-cell--actions">
          <div class="skeleton-action-btn skeleton-pulse" />
          <div class="skeleton-action-btn skeleton-pulse" />
        </div>
      </div>
    </div>
...
.skeleton-header-row {
  display: grid;
  grid-template-columns: 48px 2fr 60px 80px 100px 1.2fr 100px;
  gap: 12px;
  padding: 14px 20px;
...
.skeleton-cell--actions { flex-direction: row; gap: 6px; justify-content: flex-end; }
...
.skeleton-line--tertiary { width: 40%; height: 8px; opacity: 0.4; }
.skeleton-line--short { width: 32px; }
.skeleton-line--medium { width: 52px; }
